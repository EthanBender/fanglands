...
| **World reshape** | Still to build: 12+ outposts with unique activities; a real height layer so you walk under and over the rope bridges. (Outlines, the stepped land and the roads: see LIVE.) |
