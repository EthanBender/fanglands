...
// ============================================================================
{
  ...
  const SHRINE_T = { x: 65, y: 3 }, STEP_T = { x: 65, y: 4 }; // east of the Agility cliff course (x 46–62), which carves the quarry's north edge
