...
// ============================================================================
{
  ...
  { const jg = bandS('The Jungle', 6, SEED + 14, 12, true); const je = bandX('The Jungle', 13, SEED + 15, 9, true);
    put('The Jungle', (x, y) => x >= 100 && (x > 161 ? y >= BOX['The Jungle'].y0 : y > sWJ(x)) && (je(x, y) || jg(x, y) || near(x, y, 108, 90, 7, 8) || near(x, y, 156, 90, 8, 7)), 'ne'); }
