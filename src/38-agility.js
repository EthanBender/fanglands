...
// ============================================================================
{
  ...
  function capesGeom(g) {
    ...
    const w = Math.min(PANEL_KIT.room().aw, 520), inner = w - 36, bw = touchMode() ? 112 : 100;
  ...
  // the panel audit's scene (PLACE_KIT, run from 63-house): 2,000 coins, two skills at 99, one cape owned, first and last page
  PLACE_KIT.scene({
