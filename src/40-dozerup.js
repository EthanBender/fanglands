...
// ============================================================================
{
  ...
  function bayGeom(g) {
    ...
    const w = Math.min(PANEL_KIT.room().aw, 640), inner = w - 36, wide = inner >= 470, bw = touchMode() ? 116 : 104;
    ...
    const foot = R + 8, room = PANEL_KIT.room().ah - 62 - 12 - foot - hintH;
  ...
  // the panel audit's scene (PLACE_KIT, run from 63-house): the drill fitted, two blueprints held, one missing
  PLACE_KIT.scene({
