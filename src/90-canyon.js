...
// ============================================================================
{
  ...
  HOOKS.selfTest.push((check, F, h) => {
    ...
    //     outer side, so the canyon floor touches the scrub at those two openings and nowhere else. A thorn bush
    //     counts as scrub only where it grows on scrub ground; bushes grow on the canyon floor as well.
    { const scrubAt = (x, y) => { const t = tileAt(x, y); return t === RC_SCRUB || (t === RC_BUSH && classOf(x, y) === 4); };
