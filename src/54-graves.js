...
// ============================================================================
{
  ...
  function gravesPlaque(g) {
    ...
    // a plaque too narrow for the risen count on the right (a landscape phone's column is 124 px) says it on the line under
    const tight = [`${q.rose} risen tonight`, `${q.rose} risen`].map(sub => Object.assign({}, base, { right: '', sub }));
    return fitFields(g, subs.map(sub => Object.assign({}, base, { sub })).concat(tight));
  }
