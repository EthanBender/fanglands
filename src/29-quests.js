...
// ============================================================================
// PLACE_KIT — the small pieces the place-and-machine panels share: the bank (60), the notice board (29), the oven
...
// PLACE_KIT.scene() registers a panel with the panel audit (run from 63-house's self-test, the last of these files).
// ============================================================================
const PLACE_KIT = (() => {
...

{
  ...
  function boardGeom(g) {
    ...
    const w = Math.min(PANEL_KIT.room().aw, 640), inner = w - 36, wide = inner >= 470;
    ...
    const foot = R + 16, room = PANEL_KIT.room().ah - 62 - foot - 8;
  ...
  // the panel audit's scene (PLACE_KIT, run from 63-house): jobs taken, one ready, one done, on the first and last page
  PLACE_KIT.scene({
