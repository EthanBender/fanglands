...
// ============================================================================
{
  ...
  for (const id of ['herb_seed', 'herbs', 'goldenwheat_seed', 'golden_wheat', 'dragonfruit_seed', 'dragonfruit', 'raw_pike', 'pike', 'raw_salmon', 'salmon',
    'raw_swordfish', 'swordfish', 'raw_shark', 'shark', 'herb_poultice', 'greater_poultice', 'scale_cloak', 'golden_bread']) {
  ...
  window.PROGRESSION = { CATCH, waterKind, seedLv, DEF_KILL_MIN, DEF_KILL_PER };
